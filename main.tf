...
# Fetch ECR authorization token to allow the Docker provider to push the image
...
# Fetch the existing Learner Lab IAM role
data "aws_iam_role" "lab" {
  name = "LabRole"
}

# Fetch the default VPC and its subnets for ECS networking
